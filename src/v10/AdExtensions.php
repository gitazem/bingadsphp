...
include 'bingads\v9\CustomerManagementClasses.php';
...
use BingAds\v10\CampaignManagement\UpdateAdExtensionsRequest;
...
use BingAds\v10\CampaignManagement\ImageAdExtension;
...
use BingAds\v10\CampaignManagement\Sitelink2AdExtension;
use BingAds\v10\CampaignManagement\StructuredSnippetAdExtension;
use BingAds\v10\CampaignManagement\KeyValuePairOfstringstring;
use BingAds\v10\CampaignManagement\AdExtensionAdditionalField;
use BingAds\v10\CampaignManagement\Schedule;
use BingAds\v10\CampaignManagement\DayTime;
...
use BingAds\v10\CampaignManagement\GetAccountMigrationStatusesRequest;
use BingAds\v10\CampaignManagement\AccountMigrationStatusesInfo;
use BingAds\v10\CampaignManagement\MigrationStatusInfo;
use BingAds\v10\CampaignManagement\MigrationStatus;
...
// Specify the BingAds\v9\CustomerManagement objects that will be used.
use BingAds\v9\CustomerManagement\GetCustomerPilotFeaturesRequest;
...
$GLOBALS['CustomerId'] = CustomerIdGoesHere;
$GLOBALS['AccountId'] = AccountIdGoesHere;

$GLOBALS['Proxy'] = null;

$GLOBALS['CustomerWsdl'] = "https://clientcenter.api.sandbox.bingads.microsoft.com/Api/CustomerManagement/v9/CustomerManagementService.svc?singleWsdl";
...
$GLOBALS['SITELINK_MIGRATION'] = "SiteLinkAdExtension";
...
try
{
    ...
    */
    ...
    $featurePilotFlags = GetCustomerPilotFeatures($CustomerId)->int;
    ...
    $accountMigrationStatusesInfos = GetAccountMigrationStatuses(array($AccountId), $GLOBALS['SITELINK_MIGRATION']);
    ...
    foreach ($accountMigrationStatusesInfos->AccountMigrationStatusesInfo as $accountMigrationStatusesInfo)
    {
        ...
        {
            if (($migrationStatusInfo->Status == MigrationStatus::Completed) && ($GLOBALS['SITELINK_MIGRATION'] == $migrationStatusInfo->MigrationType))
            {
    ...
    $addCampaignsResponse = AddCampaigns($AccountId, $campaigns);
    ...
    UpdateAdExtensions($AccountId, $updateExtensions);
    ...
    // Delete the campaign. 
    DeleteCampaigns($AccountId, array($campaignIds[0]));
